...
const CLOSING = {
  uk: 'Відповідай виключно JSON. reason — українською, одне-два речення, з посиланням на конкретний доказ.',
  ru: 'Отвечай исключительно JSON. reason — по-русски, одно-два предложения, со ссылкой на конкретное доказательство.',
  en: 'Answer with JSON only. reason — in English, one or two sentences, referencing concrete evidence.',
};
