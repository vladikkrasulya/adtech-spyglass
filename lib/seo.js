...
function renderSitemap(posts) {
  const blocks = [];
  // Sections only. '/' is deliberately excluded: it 302-redirects to /inspector
  // (root kept free for a future landing — ROADMAP Decisions 2026-05-23), and
  // listing a redirecting URL in the sitemap triggers GSC "Page with redirect".
  // /inspector is the real home and is already the first SECTION_SEO key.
