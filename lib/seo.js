...
const SECTION_SEO = {
  ...
  '/openrtb/2-6': {
    ...
    description: {
      en: 'Validate OpenRTB 2.6 BidRequest/BidResponse in your browser. What 2.6 adds over 2.5 — ad pods, SupplyChain, CTV — and the fields that trip validators. Free, client-side.',
      uk: 'Валідуй OpenRTB 2.6 BidRequest/BidResponse у браузері. Що 2.6 додає до 2.5 — ad pods, SupplyChain, CTV — і які поля валять валідацію. Безкоштовно, у браузері.',
      ru: 'Валидируй OpenRTB 2.6 BidRequest/BidResponse в браузере. Что 2.6 добавляет к 2.5 — ad pods, SupplyChain, CTV — и какие поля валят валидацию. Бесплатно, в браузере.',
    },
  },
  '/openrtb/2-5': {
    title: {
    ...
    description: {
      en: 'Validate OpenRTB 2.5 BidRequest/BidResponse in your browser — the de-facto RTB baseline. The objects that matter and the fields that trip validators. Free, client-side.',
      uk: 'Валідуй OpenRTB 2.5 BidRequest/BidResponse у браузері — фактичний базовий стандарт RTB. Об’єкти, що мають значення, і поля, які валять валідацію. Безкоштовно, у браузері.',
      ru: 'Валидируй OpenRTB 2.5 BidRequest/BidResponse в браузере — фактический базовый стандарт RTB. Объекты, которые важны, и поля, которые валят валидацию. Бесплатно, в браузере.',
    },
  },
  '/openrtb/3-0': {
    title: {
    ...
    description: {
      en: 'Validate OpenRTB 3.0 in your browser — the layered transport envelope + AdCOM model. What changed from 2.x and where 3.0 payloads break. Free, client-side.',
      uk: 'Валідуй OpenRTB 3.0 у браузері — шаровий транспортний конверт + модель AdCOM. Що змінилось із 2.x і де ламаються 3.0-payload-и. Безкоштовно, у браузері.',
      ru: 'Валидируй OpenRTB 3.0 в браузере — слоистый транспортный конверт + модель AdCOM. Что изменилось с 2.x и где ломаются 3.0-payload-ы. Бесплатно, в браузере.',
    },
  },
  '/vast': {
    title: {
    ...
    description: {
      en: 'Validate VAST video creatives in your browser. InLine vs Wrapper, where wrapper chains break, and common errors crosschecked against the bid. Free, client-side.',
      uk: 'Валідуй VAST-відеокреативи в браузері. InLine проти Wrapper, де ламаються wrapper-ланцюги, і часті помилки, звірені зі ставкою. Безкоштовно, у браузері.',
      ru: 'Валидируй VAST-видеокреативы в браузере. InLine против Wrapper, где ломаются wrapper-цепочки, и частые ошибки, сверенные со ставкой. Бесплатно, в браузере.',
    },
  },
  '/native': {
    title: {
    ...
    description: {
      en: 'Validate OpenRTB Native requests in your browser. Decode the stringified native markup and crosscheck assets request↔response. Free, client-side.',
      uk: 'Валідуй OpenRTB Native-запити в браузері. Декодуй рядкову native-розмітку і звір ассети запит↔відповідь. Безкоштовно, у браузері.',
      ru: 'Валидируй OpenRTB Native-запросы в браузере. Декодируй строковую native-разметку и сверь ассеты запрос↔ответ. Бесплатно, в браузере.',
    },
  },
  '/iab-categories': {
    title: {
