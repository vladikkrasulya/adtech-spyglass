...
(function () {
  ...
  var I18N = {
    ...
    ru: {
      ...
      'confirm.recovery_save':         'Ты точно сохранил recovery key? Без него невозможно восстановить данные если забудешь пароль.',
      'confirm.delete_sample':         'Удалить этот запрос из библиотеки?',
      'confirm.delete_partner':        'Удалить этого партнёра? Запросы, которые с ним были связаны, станут "без партнёра" (не удаляются).',
      'confirm.clear_history':         'Очистить всю историю? Сохранённые в библиотеке записи не затрагиваются.',
      'confirm.clobber_load':          'Текущие изменения не сохранены. Загрузить этот запрос и отбросить изменения?',
      ...
      'recovery.body':                 'Это <b>единственный</b> способ восстановить доступ к твоей библиотеке если забудешь пароль. Я (оператор сервера) не имею его и не смогу восстановить твои данные без него. Запиши его в password-manager или на бумаге.',
      ...
      'reset.mode.recover_hint':       '32-символьный ключ, который показывали при регистрации. Библиотека сохранится.',
      ...
      'reset.wipe_warn':               '<b>Это уничтожит все ваши сохранённые запросы и партнёров.</b> Зашифрованные данные нельзя восстановить без пароля или recovery key.',
