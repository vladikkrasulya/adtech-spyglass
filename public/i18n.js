...
(function () {
  ...
  const I18N = {
    uk: {
      ...
      'verdict.blocked': 'Цей бід не відкрутиться',
      'verdict.blocker_one': 'блокер',
      'verdict.blockers': 'блокери',
      'verdict.blockers_many': 'блокерів',
      'verdict.tofix': 'до виправлення',
      'verdict.analyzed': 'Аналіз {time}, рушій {engine}.',
      'group.blocking': 'Блокує',
      'group.should_fix': 'Варто виправити',
      'group.needs_input': 'Потрібне твоє рішення',
      'group.info': 'Інфо',
      'finding.side.request': 'запит',
      'nav.inspector': 'Інспектор',
      'workbar.json_valid': 'JSON валідний',
      'workbar.json_invalid': 'JSON невалідний',
      'finding.action.fix': 'Виправити в редакторі',
      'finding.action.map': 'Розмітити',
      'finding.line': 'рядок {n}',
      'finding.side.response': 'відповідь',
      ...
      'onboarding.banner.text':
        'Немає JSON? Відкрий «Завантажити зразок» і вибери синтетичний приклад.',
    ...
    en: {
      ...
      'builder.cluster_meta': 'Fields: {n} · score {score}',
      ...
      'verdict.blocked': 'This bid will not serve',
      'verdict.blocker_one': 'blocking issue',
      'verdict.blockers': 'blocking issues',
      'verdict.blockers_many': 'blocking issues',
      'verdict.tofix': 'to fix',
      'verdict.analyzed': 'Analyzed {time}, engine {engine}.',
      'group.blocking': 'Blocking',
      'group.should_fix': 'Should fix',
      'group.needs_input': 'Needs your input',
      'group.info': 'Info',
      'finding.side.request': 'request',
      'nav.inspector': 'Inspector',
      'workbar.json_valid': 'JSON valid',
      'workbar.json_invalid': 'JSON invalid',
      'finding.action.fix': 'Fix in editor',
      'finding.action.map': 'Map it',
      'finding.line': 'line {n}',
      'finding.side.response': 'response',
      ...
      // ── first-visit inspector onboarding ─────────────────
      'onboarding.banner.text': 'No JSON yet? Open “Load sample” and choose a synthetic example.',
    ...
    ru: {
      ...
      'verdict.blocked': 'Этот бид не открутится',
      'verdict.blocker_one': 'блокер',
      'verdict.blockers': 'блокера',
      'verdict.blockers_many': 'блокеров',
      'verdict.tofix': 'к исправлению',
      'verdict.analyzed': 'Анализ {time}, движок {engine}.',
      'group.blocking': 'Блокирует',
      'group.should_fix': 'Стоит исправить',
      'group.needs_input': 'Нужно твоё решение',
      'group.info': 'Инфо',
      'finding.side.request': 'запрос',
      'nav.inspector': 'Инспектор',
      'workbar.json_valid': 'JSON валидный',
      'workbar.json_invalid': 'JSON невалидный',
      'finding.action.fix': 'Исправить в редакторе',
      'finding.action.map': 'Разметить',
      'finding.line': 'строка {n}',
      'finding.side.response': 'ответ',
      ...
      // ── first-visit inspector onboarding ─────────────────
      'onboarding.banner.text':
        'Нет JSON? Открой «Загрузить пример» и выбери синтетический пример.',
