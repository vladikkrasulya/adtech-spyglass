  ...
  const I18N = {
    uk: {
      ...
      'modal.mirror.mode.best_practice':
        'best-practice · з recommended (schain, dchain, DSA, GDPR)',
      'modal.mirror.diff_label': 'diff: твоя версія vs канонічна',
      'modal.mirror.diff_legend':
        '≠ розбіжність   + у канонічній є, у тебе немає   − у тебе є, в канонічній немає',
      'modal.mirror.diff_no_changes':
        'Все співпадає на верхньому рівні — твоя версія структурно еквівалентна канонічній.',
    ...
    en: {
      ...
      'modal.mirror.mode.best_practice':
        'best-practice · with recommended (schain, dchain, DSA, GDPR)',
      'modal.mirror.diff_label': 'diff: your version vs canonical',
      'modal.mirror.diff_legend':
        '≠ different   + canonical has, you don’t   − you have, canonical doesn’t',
      'modal.mirror.diff_no_changes':
        'Everything matches at the top level — your version is structurally equivalent to the canonical one.',
    ...
    ru: {
      ...
      'modal.mirror.mode.best_practice':
        'best-practice · с recommended (schain, dchain, DSA, GDPR)',
      'modal.mirror.diff_label': 'diff: твоя версия vs каноническая',
      'modal.mirror.diff_legend':
        '≠ различие   + в канонической есть, у тебя нет   − у тебя есть, в канонической нет',
      'modal.mirror.diff_no_changes':
        'Всё совпадает на верхнем уровне — твоя версия структурно эквивалентна канонической.',
