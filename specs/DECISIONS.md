...
| [ADR-006](./decisions/ADR-006-immutable-exact-sha-deployments.md)           | Accepted; amended by ADR-013 | 2026-06-28 | Deploy immutable commit-addressed images through readiness, smoke, and rollback gates                                                                    |
...
| [ADR-010](./decisions/ADR-010-supported-agents-safe-automation.md)          | Accepted; amended by ADR-013 | 2026-08-11 | Support four manifest-managed agents and keep automatic or third-party automation outside the initial safety boundary                                    |
...
| [ADR-013](./decisions/ADR-013-standing-release-authorization.md)            | Accepted                     | 2026-08-25 | Scoped commits, main pushes, canonical backup/deploy and rollback carry standing authorization under stated conditions                                   |
| [ADR-014](./decisions/ADR-014-default-locale-english.md)                    | Accepted                     | 2026-08-27 | `server.js` default locale becomes English, matching the canonical-en convention everywhere else; breaking for callers that omit `?locale=`              |
| [ADR-015](./decisions/ADR-015-storable-roles-and-response-variants.md)      | Accepted                     | 2026-09-02 | Nine storable role labels and three new suggest-label response variants extend the dialect contract; four surfaces move together under a Core MINOR bump |
