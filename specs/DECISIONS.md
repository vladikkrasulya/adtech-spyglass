...
| [ADR-003](./decisions/ADR-003-deterministic-interactive-intel.md)        | Accepted | 2026-07-22 | Interactive intelligence and news relevance use deterministic rules; model use is isolated to news transformation          |
