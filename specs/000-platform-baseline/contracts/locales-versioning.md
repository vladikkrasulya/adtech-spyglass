...
| ----------------- | --------------- | ---------------------------- | ------------------------------------------------------------------ |
| Web application   | `1.6.0`         | root `package.json`          | root lock metadata, `public/version.js`, and static HTML fallbacks |
| `@ortbtools/core` | `0.31.0`        | `packages/core/package.json` | its package-lock workspace metadata and documented Core contract   |
