...
| ----------------- | --------------- | ---------------------------- | ------------------------------------------------------------------ |
| Web application   | `1.7.0`         | root `package.json`          | root lock metadata, `public/version.js`, and static HTML fallbacks |
| `@ortbtools/core` | `0.32.0`        | `packages/core/package.json` | its package-lock workspace metadata and documented Core contract   |
