...
## Status as of 2026-09-09 (`f01fbd2`, app 1.20.0, Core 0.46.0)

The counts in this document were established against `a61fc25` with Core `0.38.0`, before features 021
through 031. An independent review of the 020 closure pointed out, correctly, that quoting "23 items"
afterwards asserts a currency this inventory no longer had. Every item below — the 23 consolidated
items and the ten CL threads, 33 in all — was re-checked by reading its cited code in the current
tree and re-running an equivalent reproduction wherever the original evidence used one.

**4 fixed · 26 open · 1 superseded · 2 unverifiable.**

Almost nothing was fixed incidentally: the features that landed since were scoped to the corpus
defect ledger, and this inventory is deliberately separate from it. That is the honest headline, and
it is the opposite of what "some of them are surely done by now" would have assumed.

| Item                  | Status       | Note                                                                                                                                                                                                                      |
| --------------------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `scattered-format-01` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `scattered-format-02` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `scattered-format-07` | Fixed        | Closed by feature 025: `rules-feed.js` accepts the bare `clickurl` alias.                                                                                                                                                 |
| `dom-css-fragile-001` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `fallbacks-silent-01` | Fixed        | Closed in two halves: feature 027 cleared the stale result on a structured server error; feature 031 made the guard exhaustive, so a 2xx that is not the documented envelope is explained instead of stopping in silence. |
| `scattered-format-06` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `fallbacks-silent-04` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `fallbacks-silent-05` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `fallbacks-silent-06` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `scattered-format-08` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `fallbacks-silent-03` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dup-core-ui-003`     | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-04`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `scattered-format-03` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dup-core-ui-005`     | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `scattered-format-05` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-01`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-03`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-02`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-06`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-07`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `dead-stale-05`       | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `fallbacks-silent-02` | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `CL-01`               | Fixed        | Closed by feature 022: one price/floor predicate, no coercion, one deal-floor resolver.                                                                                                                                   |
| `CL-02`               | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `CL-03`               | Superseded   | Superseded: the two protocol-family tables are a documented, deliberate and now tested distinction rather than a drift to centralize.                                                                                     |
| `CL-04`               | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `CL-05`               | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `CL-06`               | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `CL-07`               | Open         | Reproduces at its cited location.                                                                                                                                                                                         |
| `CL-08`               | Unverifiable | Unverifiable as written — the item carries no file or assertion to check, by its own admission.                                                                                                                           |
| `CL-09`               | Unverifiable | Unverifiable as written — same.                                                                                                                                                                                           |
| `CL-10`               | Fixed        | Closed by feature 022: the audit oracle uses the normative `flrcur`.                                                                                                                                                      |

One item is recorded here for the first time, raised by the same review and verified independently:

| Item                       | Status | Note                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| -------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `negative-floor-unflagged` | Open   | A supplied `imp.bidfloor` of `-1` receives no finding at all. `imp.bidfloor_invalid` fires only on a non-number, and `-1` is a number; the paired crosscheck then reports `crosscheck.bid.above_floor` as satisfied, because any price exceeds a negative floor. A floor that cannot be enforced is not a floor, and nothing says so. Noted as out-of-scope during feature 022 and still unaddressed; `packages/core/rules-request.js`, `rules/price-floor/index.js` and `crosscheck.js` contain no negative-floor check. |

Statuses, not schedules: none of the open items is scheduled here, and the priorities and sizes in the
tables below are the original estimates, unchanged.
