...
| Where is validation semantics tracked?              | [026 validation and crosscheck](./026-validation-crosscheck/spec.md), [tasks](./026-validation-crosscheck/tasks.md) and [verification](./026-validation-crosscheck/verification.md)     |
| Where is vendor carrier inspection tracked?         | [028 vendor request dialects](./028-vendor-request-dialects/spec.md), [tasks](./028-vendor-request-dialects/tasks.md) and [verification](./028-vendor-request-dialects/verification.md) |
